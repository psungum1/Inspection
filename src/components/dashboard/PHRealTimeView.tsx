...
const TAGS = [
  { key: 'RE1_1-PH', label: 'RE1_1', color: '#3b82f6', name: 'RE1_1' },
  { key: 'RE1_2-PH', label: 'RE1_2', color: '#22c55e', name: 'RE1_2' },
  { key: 'RE1_3-PH', label: 'RE1_3', color: '#f59e42', name: 'RE1_3' },
  { key: 'RE1_4-PH', label: 'RE1_4', color: '#e11d48', name: 'RE1_4' },
  { key: 'RE1_5-PH', label: 'RE1_5', color: '#a21caf', name: 'RE1_5' },
  { key: 'RE1_6-PH', label: 'RE1_6', color: '#0ea5e9', name: 'RE1_6' },
];
...
const PHRealTimeView: React.FC = () => {
  ...
  useEffect(() => {
    ...
    wsRef.current.onopen = () => {
      console.log('PH WebSocket connected');
    ...
    wsRef.current.onmessage = (event) => {
      ...
      // Only process PH tags
      if (tag && tag.includes('-PH')) {
        setSeries(prev => {
    ...
    wsRef.current.onerror = (error) => {
      console.error('PH WebSocket error:', error);
      setConnectionStatus('disconnected');
    };

    wsRef.current.onclose = () => {
      console.log('PH WebSocket disconnected');
      setConnectionStatus('disconnected');
    };
  ...
  const getTableData = (): PHRecord[] => {
    const allRecords: PHRecord[] = [];
    ...
    return (
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <div className="flex items-center justify-between mb-4">
          <h3 className="text-lg font-semibold">PH Real-Time Monitoring</h3>
          <div className="text-sm text-gray-500">Waiting for data...</div>
        </div>
        <div className="h-64 flex items-center justify-center text-gray-400">
          <div className="text-center">
            <div className="animate-pulse">⏳</div>
            <div className="mt-2">Connecting to real-time PH data...</div>
          </div>
        </div>
      </div>
    );
  ...
  return (
    <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
      <div className="flex items-center justify-between mb-4">
        <h3 className="text-lg font-semibold text-gray-900">PH Real-Time Monitoring</h3>
      ...
      {showTable ? (
        ...
        <>
          ...
          <div className="mt-4 text-xs text-gray-500 text-center">
            Showing last {Math.min(recordCount, MAX_RECORDS)} real-time PH measurements
          </div>
        </>
      )}
    </div>
