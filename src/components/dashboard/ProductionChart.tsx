...
const TAGS = [
  { key: 'RE1_1-PH', label: 'RE1_1', color: '#3b82f6' },
  { key: 'RE1_2-PH', label: 'RE1_2', color: '#22c55e' },
  { key: 'RE1_3-PH', label: 'RE1_3', color: '#f59e42' },
  { key: 'RE1_4-PH', label: 'RE1_4', color: '#e11d48' },
  { key: 'RE1_5-PH', label: 'RE1_5', color: '#a21caf' },
  { key: 'RE1_6-PH', label: 'RE1_6', color: '#0ea5e9' },
];
...
const ProductionChart: React.FC = () => {
    ...
    return (
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <div className="flex items-center justify-between mb-4">
          <h3 className="text-lg font-semibold">Production PH Values (Real Time)</h3>
  ...
  return (
    <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
      <div className="flex items-center justify-between mb-4">
        <h3 className="text-lg font-semibold text-gray-900">Production PH Values (Real Time)</h3>
